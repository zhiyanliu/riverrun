...
class _SyncPacketTCPServer(socketserver.ForkingMixIn, socketserver.TCPServer):
    def __init__(self, stat_queue, rtp_pkt_queue_size,
        ...
        self.rtp_pkt_queue_size = rtp_pkt_queue_size


class SyncPacketTCPReceiver:
    def __init__(self, stat_queue, rtp_pkt_queue_size=20, port=9532):
        self._server = _SyncPacketTCPServer(stat_queue, rtp_pkt_queue_size,
